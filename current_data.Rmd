...
```{r}
team_names <- c("Illinois St.", "Illinois", "Alabama", "Iowa St.", "Michigan",
                "New Hampshire", "Oklahoma", "Colgate")


# "Michigan St.", "Houston", "Clemson", "North Carolina", 
...
required_data <- online_data |>
  filter(date == as.Date("2024-12-22"))
print(required_data)
